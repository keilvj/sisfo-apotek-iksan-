...
export function LoginView({ onNavigate }: { onNavigate: (view: ViewType) => void }) {
        ...
        <div className="p-10 flex flex-col gap-10">
          ...
          <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-2">
              <label className="text-[10px] font-bold text-on-surface uppercase tracking-[2px]" htmlFor="username">Username</label>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative flex items-center">
                <input 
                  ...
                  required
                />
                <button className="absolute right-0 text-on-surface-variant hover:text-primary transition-colors focus:outline-none" type="button">
